...
<div class="container">
    ...
    <div class="row" style="margin-top: 120px;">
        <form class="col s12" action="{{  route('etiqueta.update', $etiqueta->id ) }}" method="POST">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="input-field col s6">
                    <input placeholder="Placeholder" value="{{ $etiqueta->nombre }}" name="nombre" id="first_name" type="text" class="validate">
